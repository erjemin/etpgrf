...
STRINGS_FOR_ENCODE = [
    ...
    ("϶ ℬ ℬ Β β ℶ ≬ 𝔅 𝔟", "&bepsi; &Bscr; &Bscr; &Beta; &beta; &beth; &between; &Bfr; &bfr;"),
    ...
    # ("¸ ¸ ⦲ ¢ ¢ · · ℭ 𝔠", "&cedil; &Cedilla; &cemptyv; &cent; &cent; &CenterDot; &centerdot; &Cfr; &cfr;"),
    ...
    # ("ℂ ≅ ⩭ ≡ ∯ ∮ ∮", "&complexes; &cong; &congdot; &Congruent; &Conint; &conint; &ContourIntegral;"),
    # ("ℂ 𝕔 ∐ ∐ © © © © ℗", "&Copf; &copf; &coprod; &Coproduct; &COPY; &copy; &COPY; &copy; &copysr;"),
    ...
    # ("‐ ⫤ ⊣ ⤏ ˝ Ď ď Д д ⅅ", "&dash; &Dashv; &dashv; &dbkarow; &dblac; &Dcaron; &dcaron; &Dcy; &dcy; &DD;"),
    # ("ⅆ ‡ ⇊ ⤑ ⩷ ° ° ∇ Δ δ", "&dd; &ddagger; &ddarr; &DDotrahd; &ddotseq; &deg; &deg; &Del; &Delta; &delta;"),
    ...
    # ("ⅆ ϝ ⋲ ÷ ÷ ÷ ⋇", "&DifferentialD; &digamma; &disin; &div; &divide; &divide; &divideontimes;"),
    ...
    # ("è ⪖ ⪘ ⪙ ∈ ⏧ ℓ ⪕ ⪗ Ē", "&egrave; &egs; &egsdot; &el; &Element; &elinters; &ell; &els; &elsdot; &Emacr;"),
    ...
    # ("≂ ⪖ ⪕ ⩵ = ≂ ≟", "&eqsim; &eqslantgtr; &eqslantless; &Equal; &equals; &EqualTilde; &equest;"),
    # ("⇌ ≡ ⩸ ⧥ ⥱ ≓ ℰ ℯ", "&Equilibrium; &equiv; &equivDD; &eqvparsl; &erarr; &erDot; &Escr; &escr;"),
    # ("≐ ⩳ ≂ Η η Ð ð Ð ð Ë ë Ë", "&esdot; &Esim; &esim; &Eta; &eta; &ETH; &eth; &ETH; &eth; &Euml; &euml; &Euml;"),
    # ("ë € ! ∃ ∃ ℰ ⅇ", "&euml; &euro; &excl; &exist; &Exists; &expectation; &ExponentialE;"),
    # ("ⅇ ≒ Ф ф ♀ ﬃ ﬀ ﬄ", "&exponentiale; &fallingdotseq; &Fcy; &fcy; &female; &ffilig; &fflig; &ffllig;"),
    # ("𝔉 𝔣 ﬁ ◼ ▪ ♭ ﬂ", "&Ffr; &ffr; &filig; &FilledSmallSquare; &FilledVerySmallSquare; &flat; &fllig;"),
    # ("▱ ƒ 𝔽 𝕗 ∀ ∀ ⋔ ⫙ ℱ", "&fltns; &fnof; &Fopf; &fopf; &ForAll; &forall; &fork; &forkv; &Fouriertrf;"),
    ...
    # ("≳ 𝒢 ℊ ≳ ⪎ ⪐ > > > ≫ >", "&GreaterTilde; &Gscr; &gscr; &gsim; &gsime; &gsiml; &GT; &gt; &GT; &Gt; &gt;"),
    # ("⪧ ⩺ ⋗ ⦕ ⩼ ⪆ ⥸ ⋗", "&gtcc; &gtcir; &gtdot; &gtlPar; &gtquest; &gtrapprox; &gtrarr; &gtrdot;"),
    # ("⋛ ⪌ ≷ ≳ ˇ   ½ ℋ", "&gtreqless; &gtreqqless; &gtrless; &gtrsim; &Hacek; &hairsp; &half; &hamilt;"),
    # ("Ъ ъ ⇔ ↔ ⥈ ↭ ^ ℏ Ĥ ĥ", "&HARDcy; &hardcy; &hArr; &harr; &harrcir; &harrw; &Hat; &hbar; &Hcirc; &hcirc;"),
    # ("♥ ♥ … ⊹ ℌ 𝔥 ℋ ⤥", "&hearts; &heartsuit; &hellip; &hercon; &Hfr; &hfr; &HilbertSpace; &hksearow;"),
    # ("⤦ ⇿ ∻ ↩ ↪ ℍ 𝕙", "&hkswarow; &hoarr; &homtht; &hookleftarrow; &hookrightarrow; &Hopf; &hopf;"),
    # ("― ─ ℋ 𝒽 ℏ Ħ ħ", "&horbar; &HorizontalLine; &Hscr; &hscr; &hslash; &Hstrok; &hstrok;"),
    ...
    # ("¡ ¡ ⇔ ℑ 𝔦 Ì ì Ì ì ⅈ", "&iexcl; &iexcl; &iff; &Ifr; &ifr; &Igrave; &igrave; &Igrave; &igrave; &ii;"),
    # ("⨌ ∭ ⧜ ℩ Ĳ ĳ ℑ Ī ī ℑ", "&iiiint; &iiint; &iinfin; &iiota; &IJlig; &ijlig; &Im; &Imacr; &imacr; &image;"),
    # ("ⅈ ℐ ℑ ı ⊷ Ƶ ⇒ ∈", "&ImaginaryI; &imagline; &imagpart; &imath; &imof; &imped; &Implies; &in;"),
    # ("℅ ∞ ⧝ ı ∬ ∫ ⊺ ℤ", "&incare; &infin; &infintie; &inodot; &Int; &int; &intcal; &integers;"),
    ...
    # ("⨼ ¿ ¿ ℐ 𝒾 ∈ ⋵ ⋹ ⋴", "&iprod; &iquest; &iquest; &Iscr; &iscr; &isin; &isindot; &isinE; &isins;"),
    ...
    # ("𝕜 𝒦 𝓀 ⇚ Ĺ ĺ ⦴ ℒ Λ", "&kopf; &Kscr; &kscr; &lAarr; &Lacute; &lacute; &laemptyv; &lagran; &Lambda;"),
    # ("λ ⟪ ⟨ ⦑ ⟨ ⪅ ℒ « «", "&lambda; &Lang; &lang; &langd; &langle; &lap; &Laplacetrf; &laquo; &laquo;"),
    ...
    # ("◊ ⧫ ( ⦓ ⇆ ⌟ ⇋ ⥭ ‎", "&lozenge; &lozf; &lpar; &lparlt; &lrarr; &lrcorner; &lrhar; &lrhard; &lrm;"),
    # ("⊿ ‹ ℒ 𝓁 ↰ ↰ ≲ ⪍ ⪏ [", "&lrtri; &lsaquo; &Lscr; &lscr; &Lsh; &lsh; &lsim; &lsime; &lsimg; &lsqb;"),
    ...
    # ("— ∺ ∡   ℳ 𝔐 𝔪 ℧", "&mdash; &mDDot; &measuredangle; &MediumSpace; &Mellintrf; &Mfr; &mfr; &mho;"),
    ...
    # ("∓ ℳ 𝓂 ∾ Μ μ ⊸ ⊸ ∇ Ń", "&mp; &Mscr; &mscr; &mstpos; &Mu; &mu; &multimap; &mumap; &nabla; &Nacute;"),
    # ("ń ≉ ŉ ≉ ♮ ♮ ℕ    ", "&nacute; &nap; &napos; &napprox; &natur; &natural; &naturals; &nbsp; &nbsp;"),
    ...
    # ("⋪ ⋬ ∤ ⁠   ℕ 𝕟 ¬ ⫬", "&nltri; &nltrie; &nmid; &NoBreak; &NonBreakingSpace; &Nopf; &nopf; &not; &Not;"),
    ...
    # ("⩝ ℴ ℴ ª ª º º ⊶ ⩖ ⩗", "&ord; &order; &orderof; &ordf; &ordf; &ordm; &ordm; &origof; &oror; &orslope;"),
    ...
    # ("ℳ ☎ Π π ⋔ ϖ ℏ ℎ ℏ", "&phmmat; &phone; &Pi; &pi; &pitchfork; &piv; &planck; &planckh; &plankv;"),
    # ("+ ⨣ ⊞ ⨢ ∔ ⨥ ⩲ ±", "&plus; &plusacir; &plusb; &pluscir; &plusdo; &plusdu; &pluse; &PlusMinus;"),
    # ("± ± ⨦ ⨧ ± ℌ ⨕ ℙ", "&plusmn; &plusmn; &plussim; &plustwo; &pm; &Poincareplane; &pointint; &Popf;"),
    ...
    # ("′ ℙ ⪹ ⪵ ⋨ ∏ ∏ ⌮", "&prime; &primes; &prnap; &prnE; &prnsim; &prod; &Product; &profalar;"),
    ...
    # ("⁗ 𝒬 𝓆 ℍ ⨖ ? ≟ " "", "&qprime; &Qscr; &qscr; &quaternions; &quatint; &quest; &questeq; &QUOT; &quot;"),
    ...
    # ("↣ ↝ ⤜ ⤚ ∶ ℚ ⤐ ⤏ ⤍", "&rarrtl; &rarrw; &rAtail; &ratail; &ratio; &rationals; &RBarr; &rBarr; &rbarr;"),
    ...
    # ("↳ ℜ ℜ ℛ ℜ ℝ ▭ ® ® ® ®", "&rdsh; &Re; &real; &realine; &realpart; &reals; &rect; &REG; &reg; &REG; &reg;"),
    # ("∋ ⇋ ⥯ ⥽ ⌋", "&ReverseElement; &ReverseEquilibrium; &ReverseUpEquilibrium; &rfisht; &rfloor;"),
    # ("ℜ 𝔯 ⥤ ⇁ ⇀ ⥬ Ρ ρ ϱ", "&Rfr; &rfr; &rHar; &rhard; &rharu; &rharul; &Rho; &rho; &rhov;"),
    # ("⟩ → ⇒ → ⇥", "&RightAngleBracket; &RightArrow; &Rightarrow; &rightarrow; &RightArrowBar;"),
    # ("⇄ ↣ ⌉ ⟧", "&RightArrowLeftArrow; &rightarrowtail; &RightCeiling; &RightDoubleBracket;"),
    # ("⥝ ⇂ ⥕ ⌋", "&RightDownTeeVector; &RightDownVector; &RightDownVectorBar; &RightFloor;"),
    # ("⇁ ⇀ ⇄ ⇌", "&rightharpoondown; &rightharpoonup; &rightleftarrows; &rightleftharpoons;"),
    ...
    # ("⥔ ⇀ ⥓ ˚ ≓", "&RightUpVectorBar; &RightVector; &RightVectorBar; &ring; &risingdotseq;"),
    # ("⇄ ⇌ ‏ ⎱ ⎱ ⫮ ⟭ ⇾ ⟧", "&rlarr; &rlhar; &rlm; &rmoust; &rmoustache; &rnmid; &roang; &roarr; &robrk;"),
    # ("⦆ ℝ 𝕣 ⨮ ⨵ ⥰ ) ⦔", "&ropar; &Ropf; &ropf; &roplus; &rotimes; &RoundImplies; &rpar; &rpargt;"),
    # ("⨒ ⇉ ⇛ › ℛ 𝓇 ↱ ↱ ]", "&rppolint; &rrarr; &Rrightarrow; &rsaquo; &Rscr; &rscr; &Rsh; &rsh; &rsqb;"),
    # ("’ ’ ⋌ ⋊ ▹ ⊵ ▸ ⧎", "&rsquo; &rsquor; &rthree; &rtimes; &rtri; &rtrie; &rtrif; &rtriltri;"),
    ...
    # ("  𝔙 𝔳 ⊲ 𝕍 𝕧 ∝ ⊳ 𝒱", "&VeryThinSpace; &Vfr; &vfr; &vltri; &Vopf; &vopf; &vprop; &vrtri; &Vscr;"),
    ...
    # ("Ź ź Ž ž З з Ż ż ℨ", "&Zacute; &zacute; &Zcaron; &zcaron; &Zcy; &zcy; &Zdot; &zdot; &zeetrf;"),
    # ("​ Ζ ζ ℨ 𝔷 Ж ж ⇝ ℤ", "&ZeroWidthSpace; &Zeta; &zeta; &Zfr; &zfr; &ZHcy; &zhcy; &zigrarr; &Zopf;"),
]
